...
|---------|-----------|----------|---------|-------------|
| [notebook-to-prod-template](https://github.com/Br111t/notebook-to-prod-template) | ![CI](https://github.com/Br111t/notebook-to-prod-template/actions/workflows/ci.yml/badge.svg?branch=main) | 🔥 Heating Up | ⭐ 1 |  📓 Jupyter Notebook, 🐍 Python, 🐳 Dockerfile |
| [finrisk-sim-svc](https://github.com/Br111t/finrisk-sim-svc) | 🚧 Pending | 🟢 Active | ⭐ 1 |  ❌ |
| [wellsrag-advisor](https://github.com/Br111t/wellsrag-advisor) | 🚧 Pending | 🟢 Active | ⭐ 1 |  ❌ |
| [agent-ops](https://github.com/Br111t/agent-ops) | ![CI](https://github.com/Br111t/agent-ops/actions/workflows/ci.yml/badge.svg?branch=main) | 🟢 Active | ⭐ 1 |  🐍 Python |
<!-- CI-BADGE-END -->
